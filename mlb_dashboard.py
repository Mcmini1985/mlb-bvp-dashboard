...
# Display ET date in header
et_now = datetime.now(tz=ZoneInfo("America/New_York"))
st.caption(f"Full BvP Data — Live from MLB API • {et_now.strftime('%B %d, %Y')} ET")
